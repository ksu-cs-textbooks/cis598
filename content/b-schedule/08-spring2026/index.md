...
|:-------:|:-------:|:-------:|:----:|:----:|:--------:|:----:|
| [LLMGuard:<br>An Integrity Attestation Framework<br>for Large Language Models]({{% relref "08-spring2026#e0" %}}) | Aayush Rai | Vasserman | Wed, May 6 | 11:30 AM | {{% badge style="grey" title="DUE" %}}2183{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [Ascend: An RPG-Based<br>Fitness Tracking Application]({{% relref "08-spring2026#e3" %}}) | Johnny Hug | Weese | Tue, May 12 | 8:45 AM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Revix for Educators]({{% relref "08-spring2026#e4" %}}) | Kevin Roy | Shamir | Tue, May 12 | 9:00 AM | {{% badge style="grey" title="DUE" %}}2183{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [Good Reviews]({{% relref "08-spring2026#e5" %}}) | Andrew Osterhaus | Feldhausen | Tue, May 12 | 9:30 AM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Minecraft<br>Variational Autoencoder]({{% relref "08-spring2026#e6" %}}) | Henry Hornung | Shamir | Tue, May 12 | 9:45 AM | {{% badge style="grey" title="DUE" %}}2183{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [Urban Flow]({{% relref "08-spring2026#e7" %}}) | Christian Ramirez-Chavez | Valenzuela | Tue, May 12 | 10:15 AM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [ComparePro]({{% relref "08-spring2026#e8" %}}) | Clayton Burgess | Thornton | Tue, May 12 | 10:30 AM | {{% badge style="grey" title="DUE" %}}2183{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [Ascend]({{% relref "08-spring2026#e9" %}}) | Kaitlyn Pritchard | Feldhausen | Tue, May 12 | 12:00 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Shooting Guys 3]({{% relref "08-spring2026#e10" %}}) | Hunter Evans | Bean | Tue, May 12 | 12:45 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Split Chase]({{% relref "08-spring2026#e11" %}}) | Joey Monaco | Bean | Tue, May 12 | 1:30 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Crucidex]({{% relref "08-spring2026#e12" %}}) | Jess Barrett | Bean | Tue, May 12 | 2:15 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Protocol: Automata]({{% relref "08-spring2026#e13" %}}) | Carson Kinsch | Bean | Tue, May 12 | 3:00 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Farpoint Training]({{% relref "08-spring2026#e14" %}}) | Josh Caldwell | Keller | Tue, May 12 | 3:45 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Zactify Insights]({{% relref "08-spring2026#e15" %}}) | Zac Atchison | Thornton | Tue, May 12 | 4:30 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Jetski Maintenance Tracker]({{% relref "08-spring2026#e17" %}}) | Colin Harrison | Andresen | Wed, May 13 | 8:45 AM |  {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [RideCircle]({{% relref "08-spring2026#e18" %}}) | Jake May | Weese | Wed, May 13 | 9:30 AM |  {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [Recip-EZ]({{% relref "08-spring2026#e19" %}}) | Caden Swanson | Weese | Wed, May 13 | 10:15 AM |  {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [Where Did They Go?]({{% relref "08-spring2026#e20" %}}) | Evan Harris<br>Amala John<br>Joshua Zrubek | Bean | Wed, May 13 | 11:00 AM |  {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [LibraryLive]({{% relref "08-spring2026#e21" %}}) | Mark Preston | Valenzuela | Wed, May 13 | 11:45 AM |  {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [Agricultural Microworld Simulation]({{% relref "08-spring2026#e22" %}}) | Max Casey<br>Daniel Cortez<br>Dakota Denton<br>Jackson Seim | Bean | Wed, May 13 | 1:00 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
...
| [Formal Analysis of<br>the Signal Protocol]({{% relref "08-spring2026#e27" %}}) | Trenton Chrisco<br>Beny Christian<br>Garrett Greathouse<br>Easton Hain<br>Gavin Kellam<br>Vania Santillana | Vasserman | Wed, May 13 | 2:45 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Verbum]({{% relref "08-spring2026#e28" %}}) | Owen Pearsall | Amtoft | Wed, May 13 | 3:30 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Volant Reader]({{% relref "08-spring2026#e29" %}}) | Robby Clausel | Andresen | Wed, May 13 | 4:00 PM | {{% badge style="grey" title="DUE" %}}2183{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
| [Shopnow]({{% relref "08-spring2026#e30" %}}) | Dean Blickenstaff | Feldhausen | Wed, May 13 | 4:15 PM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
| [Cart Pilot]({{% relref "08-spring2026#e31" %}}) | Takumi Hendricks | Keller | Thur, May 14 | 8:15 AM | {{% badge style="grey" title="DUE" %}}2183{{% /badge %}} | {{% button href="https://bit.ly/cis598s26b" style="grey" %}}Zoom B{{% /button %}} |
...
## LLMGuard: An Integrity Attestation Framework for Large Language Models {#e0}
...
## Ascend: An RPG-Based Fitness Tracking Application {#e3}
...
Upload your lesson materials once. Within minutes:
✅ Your slides are ready
✅ Your assignments are generated
✅ Your students each get a custom study set on revix ai tied directly to what you taught
...
What this means
🧑‍🏫 For teachers: Less busywork. Real insight. And a few hours back in your week.
🧑‍🎓 For students: Low-pressure check-ins and personalized support the moment they struggle.

## Good Reviews {#e5}

Andrew Osterhaus

![Image](images/osterhaus.jpg)
...
## Minecraft Variational Autoencoder {#e6}

Henry Hornung

![Image](images/hornung.jpg)
...
![Image](images/ramirez-chavez.png)
...
## Protocol: Automata {#e13}

Carson Kinsch

![Image](images/kinsch.png)
...
## Farpoint Training{#e14}

Josh Caldwell

![Image](images/caldwell.png)
...
## Zactify Insights {#e15}

Zac Atchison

![Image](images/atchison.jpg)
...
## Jetski Maintenance Tracker {#e17}
...
## Agricultural Microworld Simulation {#e22}

Max Casey, Daniel Cortez, Dakota Denton, Jackson Seim

![Image](images/cis643b.png)
...
![Image](images/blickenstaff.png)

Shopnow is a web-app made for retail business owners to easily host an online storefront with a connected inventory.
One business owner can manage multiple groups of stores, each with their own online inventory. Management can upload products and their data including price, images, categories, and sku information. Individual stores can keep track of their separate in-store inventory. Adding items to this in-store inventory makes them available for online order and pickup at that location.
...
## Interdisciplinary Techniques for Entropy Evaluation {#e32}

Patrick Kehoe, Timothy Larson, Creighton Moes, Nicholas Slinker, Connor Wiedenmann

![Image](images/cis599team1.jpg)
...
## When Water Isn't Save; Health Impacts in Kansas {#e33}

Kylie Phommasack

![Image](images/phommasack.png)
...
## Simulating Ethics {#e38}

Riley Reynolds

![Image](images/reynolds.jpg)

Abstract

## Shooting Guys TD {#e39}
...
## CIS 598 Dashboard {#e40}

Kasen Fudge

![Image](images/fudge.png)
...
## Dataying Block Programming {#e41}

Nalen Rangarajan

![Image](images/rangarajan.png)
...
## H.O.U.S.E.K.E.E.P.E.R {#e44}

Logan Hayward

![Image](images/hayward.jpg)
