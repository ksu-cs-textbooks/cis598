...
|:-------:|:-------:|:-------:|:----:|:----:|:--------:|:----:|
| [Title]({{% ref "08-spring2026#e1" %}}) | Student Name | Advisor | Tue, May 12 | 8:00 AM | {{% badge style="primary" title="DUE" %}}2168{{% /badge %}} | {{% button href="https://bit.ly/cis598s26a" style="primary" color="#512888" %}}Zoom A{{% /button %}} |
