...
Allowing artificial intelligence to detect trends can help write reports for businesses. In my case, I decided to aggregate the street signs. To do this I first had to collect the images from google maps API, and I then had to clean them before using AWS Rekognition. There were some discrepancies that came up from training.
