...
<div>
{{% badge style="red" %}}RED: GenAI Prohibited {{% /badge %}} You may not use GenAI to meet with your project advisor (obviously), record your time worked on the project, update your task board, or complete the biweekly sprint update. This is work that <b>you</b> are expected to do to help keep track of your progress on the project.
</div>
</div>
